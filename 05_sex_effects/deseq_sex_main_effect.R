...
deseqs = pbmclapply(names(agg_exp), function(cl_n) {
  ...
  try({
    suppressWarnings({
      ...
      res = results(deseq, tidy = T, contrast=c("sex", "F", "M")) %>%
...
saveRDS(coefs, "~/desp1/precast/prec_c25q25g3000/deseq_rhth_int2/sex_int_geno_spec/main_effect/coefs_wt_main_effect_sex.rds")

saveRDS(ncounts, "~/desp1/precast/prec_c25q25g3000/deseq_rhth_int2/sex_int_geno_spec/main_effect/counts_wt_main_effect_sex.rds")
