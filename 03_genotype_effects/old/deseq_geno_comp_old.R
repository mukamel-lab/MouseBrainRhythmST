...
saveRDS(coefs, "~/desp1/precast/prec_c25q25g3000/deseq_rhth_int2/geno_int_new/old/coefs_o.rds")

saveRDS(ncounts, "~/desp1/precast/prec_c25q25g3000/deseq_rhth_int2/geno_int_new/old/counts_o.rds")

saveRDS(res_a_w %>% bind_rows(.id="cluster"),"~/desp1/precast/prec_c25q25g3000/deseq_rhth_int2/geno_int_new/old/res_o_aw.rds")
