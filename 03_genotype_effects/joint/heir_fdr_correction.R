...
res_wt_aw = readRDS("deseq_rhth_int2/geno_int_new/joint/res_b_aw.rds") %>%
  dplyr::filter(padj<0.1)

res_wt_aw=split(res_wt_aw, res_wt_aw$cluster) 

coefs = readRDS("deseq_rhth_int2/geno_int_new/joint/coefs_b.rds")
...
saveRDS(coefs_readj, "deseq_rhth_int2/geno_int_new/joint/interaction_results_readjusted_b.rds")
