...
meta.data_org= meta.data_org%>% mutate(t_s=round(sin(2*pi*(t_s)/24)),
  ...
  rg = readRDS("~/desp1/precast/prec_c25q25g3000/deseq_rhth_int2/geno_int_new/old/interaction_results_readjusted_o.rds")
...
saveRDS(res, glue("~/desp1/precast/prec_c25q25g3000/deseq_rhth_int2/geno_int_new/shuffle_amp/true_old.rds"))
  
rg=lapply(deseqs, function(y) {y$rg}) 

saveRDS(rg, glue("~/desp1/precast/prec_c25q25g3000/deseq_rhth_int2/geno_int_new/shuffle_amp/rg_old.rds"))
