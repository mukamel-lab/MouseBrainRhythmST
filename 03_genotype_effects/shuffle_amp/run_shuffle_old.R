...
rg=readRDS("~/desp1/precast/prec_c25q25g3000/deseq_rhth_int2/geno_int_new/shuffle_amp/rg_old.rds")
...
for(i in  201:500){
  ...
  saveRDS(res, glue("~/desp1/precast/prec_c25q25g3000/deseq_rhth_int2/geno_int_new/shuffle_amp/shuffle_old/res{i}.rds"))
