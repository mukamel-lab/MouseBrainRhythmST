...
saveRDS(deseqs, "~/desp1/supplemental_tables/rhythmic_genes_APP23_cluster_level.rds")
openxlsx::write.xlsx(deseqs, "~/desp1/supplemental_tables/rhythmic_genes_APP23_cluster_level.xlsx")
