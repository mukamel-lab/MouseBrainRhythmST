...
saveRDS(deseqs, "~/desp1/supplemental_tables/region_DRG_APP23_cluster_level.rds")

deseqs=deseqs[sapply(deseqs, class)=="data.frame"]

deseqs=bind_rows(deseqs)

openxlsx::write.xlsx(deseqs, "~/desp1/supplemental_tables/region_DRG_APP23_cluster_level.xlsx")
